...
export default function WizardStep3Device({
  ...
  return (
    <div className="py-2 flex flex-col gap-5">
      ...
      {fetchError && (
        <div className="flex items-center gap-3 bg-accent-red/10 border border-accent-red/25 rounded-xl px-4 py-3">
              ...
              <DetailRow
                ...
                value={
                  <span className="flex items-center gap-2">
                    <span className="font-mono text-2xs truncate max-w-[200px]">
                      {device.uid}
                    </span>
                    <CopyButton text={device.uid} size="sm" />
                  </span>
                }
              />
...
function DetailRow({
  ...
  return (
    <div className="flex items-center gap-4 px-4 py-2.5">
      ...
      <dd className="text-xs text-text-secondary flex items-center">
        {value}
      </dd>
    </div>
  );
